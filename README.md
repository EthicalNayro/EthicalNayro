...
* 🎓 **Education:** Practical Associate Degree in Electrical & Electronics Engineering (ORT / IAI collaboration).
...
* **Networking & Security:** `TCP/IP` | `Wireshark` | `Nmap` | `tcpdump` | `Burp Suite` | `Metasploit` | `Active Directory`
* **Programming:** `Python`
